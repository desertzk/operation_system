...
main(int argc, char *argv[])
{
  ...
  27:	ba ed 07 00 00       	mov    $0x7ed,%edx
  2c:	eb 05                	jmp    33 <main+0x33>
  2e:	ba ef 07 00 00       	mov    $0x7ef,%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 494:	e8 cb fe ff ff       	call   364 <putc>
 ...
 4be:	e8 c4 fe ff ff       	call   387 <printint>
 ...
 4e8:	e8 9a fe ff ff       	call   387 <printint>
 ...
 50f:	75 25                	jne    536 <printf+0xff>
          s = "(null)";
 511:	c7 45 f4 f6 07 00 00 	movl   $0x7f6,-0xc(%ebp)
        while(*s != 0){
 ...
 52a:	e8 35 fe ff ff       	call   364 <putc>
 ...
 557:	e8 08 fe ff ff       	call   364 <putc>
 ...
 578:	e8 e7 fd ff ff       	call   364 <putc>
 ...
 58a:	e8 d5 fd ff ff       	call   364 <putc>
 ...
 59f:	e8 c0 fd ff ff       	call   364 <putc>
...
free(void *ap)
{
 ...
 6a2:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 6a7:	90                   	nop
 6a8:	c9                   	leave  
 6a9:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6c9:	50                   	push   %eax
 6ca:	e8 75 fc ff ff       	call   344 <sbrk>
 ...
 700:	83 c4 10             	add    $0x10,%esp
  return freep;
 703:	a1 64 0a 00 00       	mov    0xa64,%eax
}
 708:	c9                   	leave  
 709:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 71c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 71f:	a1 64 0a 00 00       	mov    0xa64,%eax
 724:	89 45 f0             	mov    %eax,-0x10(%ebp)
 727:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 72b:	75 23                	jne    750 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 72d:	c7 45 f0 5c 0a 00 00 	movl   $0xa5c,-0x10(%ebp)
 734:	8b 45 f0             	mov    -0x10(%ebp),%eax
 737:	a3 64 0a 00 00       	mov    %eax,0xa64
 73c:	a1 64 0a 00 00       	mov    0xa64,%eax
 741:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    base.s.size = 0;
 746:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 74d:	00 00 00 
  }
 ...
 75e:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 761:	77 4d                	ja     7b0 <malloc+0xa6>
      if(p->s.size == nunits)
 763:	8b 45 f4             	mov    -0xc(%ebp),%eax
 766:	8b 40 04             	mov    0x4(%eax),%eax
 769:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 ...
 7a3:	a3 64 0a 00 00       	mov    %eax,0xa64
      return (void*)(p + 1);
 ...
 7ae:	eb 3b                	jmp    7eb <malloc+0xe1>
    ...
    if(p == freep)
 7b0:	a1 64 0a 00 00       	mov    0xa64,%eax
