...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 69 14 00 00       	push   $0x1469
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 2e 0f 00 00       	call   1323 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 f8 0e 00 00       	call   1323 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 95 0e 00 00       	call   1323 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 4d 0e 00 00       	call   1323 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 05 0e 00 00       	call   1323 <malloc>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 6e 14 00 00       	push   $0x146e
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 6f 14 00 00       	push   $0x146f
     772:	6a 02                	push   $0x2
     774:	e8 d7 08 00 00       	call   1050 <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 7e 14 00 00       	push   $0x147e
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 85 14 00 00       	push   $0x1485
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 87 14 00 00       	push   $0x1487
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 89 14 00 00       	push   $0x1489
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 8b 14 00 00       	push   $0x148b
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 a8 14 00 00       	push   $0x14a8
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 ab 14 00 00       	push   $0x14ab
    ...
    panic("parseblock");
     ...
     9c4:	68 ad 14 00 00       	push   $0x14ad
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 b8 14 00 00       	push   $0x14b8
    ...
    panic("syntax - missing )");
     ...
     a14:	68 ba 14 00 00       	push   $0x14ba
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 ab 14 00 00       	push   $0x14ab
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 7e 14 00 00       	push   $0x147e
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 cd 14 00 00       	push   $0x14cd
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 db 14 00 00       	push   $0x14db
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 e0 14 00 00 	mov    0x14e0(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e2:	50                   	push   %eax
    12e3:	e8 75 fc ff ff       	call   f5d <sbrk>
